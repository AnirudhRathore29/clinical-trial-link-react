...
const PhysicianTrialListing = () => {
    ...
    return (
        <>
            <div className="clinical-dashboard main-trial-listing physician-trial-listing">
            ...
            <PatientBookingProcess onlyChat="true" show={show} handleClose={handleClose} show2={show2} handleClose2={handleClose2} handleShow2={handleShow2} show3={show3} handleClose3={handleClose3} handleShow3={handleShow3} />
        </>
    );
};
