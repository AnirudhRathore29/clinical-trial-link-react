...
import { PhysicianPatientAllVisitAction } from '../../redux/actions/PhysicianAction';

const PatientAllVisit = () => {
    const PatientAllVisitList = useSelector(state => state.trial_clinic.clinic_appointment_list)
    ...
    useEffect(() => {
        dispatch(PhysicianPatientAllVisitAction({ page: LoadMoreState, patient_appointment_id: id, visit_type: SelectedTabState }))
