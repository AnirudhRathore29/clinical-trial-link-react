...
const SponsorsDashboard = (props) => {
    ...
    const DashboardData = useSelector((state) => state.My_trials.data);

    console.log("DashboardData", DashboardData !== undefined && DashboardData);
                ...
                <div className="container">
                    ...
                    <div className="row dashboard-col">
                        ...
                        <div className="col-lg-6">
                            <DashboardInfoBx
                                ...
                                // info={DashboardData !== undefined && DashboardData.data.data.data.data.totalAvailableTrials}
                            />
                        </div>
                    </div>
                    ...
                    <div className='row dashboard-col'>
                        <div className='col-lg-12'>
                            ...
                            {/* {console.log("DashboardData.data.trialClinics", DashboardData !== undefined && DashboardData.data.data.data.data.trialClinics)} */}
                            <OwlCarousel {...options}>
                                {/* {
                                    DashboardData !== undefined &&
                                    DashboardData.data.data.data.data.trialClinics?.length !== 0 ?
                                    DashboardData.data.data.data.data.trialClinics.map((value, index) => {
                                        return(
