...
export default function TrialClinicReducer(state = initialState, action) {
	...
	switch (action.type) {
		...
		case PHYSICIAN_MANGE_PATIENT_LIST_SUCCESS:
			return {
				...state,
				loading: false,
				physician_manage_patient_list: action.payload,
				clinic_appointment_list: undefined,
				error: {}
			};
		case PHYSICIAN_MANGE_PATIENT_LIST_ERROR:
			return {
				...state,
				loading: false,
				physician_manage_patient_list: {},
